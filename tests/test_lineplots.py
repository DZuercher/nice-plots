...
from niceplots.plotting import lineplot
...
@pytest.mark.parametrize(
    "get_test_inputs", [["test_lineplots"]], indirect=["get_test_inputs"]
)
def test_lineplots(get_test_inputs):
    data_labels = ("data",)
    ...
    lineplot.plot_lineplots(config, codebook, data)
